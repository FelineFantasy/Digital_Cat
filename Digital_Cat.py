    ...
    if choice == "1":
        ...
        if cat["energy"] >= 100:
            ...
            if random.random() < 0.2:
                ...
                if cat["day"] == 100:
                    ...
                    print("=" * 50)
                    print(f"ПОЗДРАВЛЯЮ! ТЫ ПРОШЁЛ ИГРУ!")
        ...
        if shop_choice == "1":
            ...
            if cat["money"] >= 10:
                ...
                print(f"Теперь монеты: {cat['money']}, счастье: {cat['happiness']}, "
            ...
            if cat["money"] >= 20:
                ...
                print(f"Теперь монеты: {cat['money']}, счастье: {cat['happiness']}, "
                      f"сытость: {cat['satiety']}, любовь: {cat['love']}, здоровье: {cat['health']}")
            else:
                print("=" * 50)
                print("Недостаточно монет!")
        else:
        ...
        if cat["energy"] <= 10:
            ...
            print("=" * 50)
            print(f"{cat['name']} помог вам с работой! -10 энергии, +{earned} монет, -5 счастья")
